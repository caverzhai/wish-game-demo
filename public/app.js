...
'zh-TW': {
    coinUnit: '枚', platformTitle: '純屬娛樂，不充值，不提現！', platformDesc: '每人送一萬許願金。隨便玩，可以押紅押綠，也可以買彩票（最高 1 中 5000），保險 + 押紅綠，可以月賺 27.5%。純屬娛樂！想接著玩的找你的推薦人吧。讓我們開啟不可思意的遊戲新天地。', appTitle: '許願池', loginTip: '連接錢包即可開始，邀請連結自動綁定推薦關係', connectWallet: '連接錢包', demoEnter: '未裝錢包？以演示身份進入', logout: '退出',
